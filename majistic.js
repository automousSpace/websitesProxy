...
const connectionData = {
  ...
  wa: {
    ...
    blockedRoutes: [
      ...
      'usages',
      '/affiliate',
      'https://wordai.zendesk.com/hc/en-us',
    ],
...
$(document).ready(function(){
  ...
  wr: {
    ...
    cookie: `_gid=GA1.2.1309378230.1626468264; PHPSESSID=4c51c8f00afdcecfc9b9660f4643f575; assistant_private_key=66b0df7b6702d1510ea6c2fe7f99245d; _hjTLDTest=1; _hjid=a08ce7c6-e660-4391-9e00-007f71795093; fs_uid=rs.fullstory.com#5NBBQ#4989905322844160:6084650182844416#725b7490#/1658004292; _hjAbsoluteSessionInProgress=0; language=en; _hjIncludedInPageviewSample=1; _hjIncludedInSessionSample=1; _ga=GA1.2.1587640777.1626468264; mp_c54553005797175c2259ba07f2c2cd0f_mixpanel=%7B%22distinct_id%22%3A%201338473%2C%22%24device_id%22%3A%20%2217ab110a1a49b2-054c5c0a4bc90f-6373264-144000-17ab110a1a56cf%22%2C%22%24initial_referrer%22%3A%20%22https%3A%2F%2Fwww.woorank.com%2Fen%2Flogin%22%2C%22%24initial_referring_domain%22%3A%20%22www.woorank.com%22%2C%22__mps%22%3A%20%7B%7D%2C%22__mpso%22%3A%20%7B%7D%2C%22__mpus%22%3A%20%7B%7D%2C%22__mpa%22%3A%20%7B%7D%2C%22__mpu%22%3A%20%7B%7D%2C%22__mpr%22%3A%20%5B%5D%2C%22__mpap%22%3A%20%5B%5D%2C%22%24user_id%22%3A%201338473%7D; _ga_Q1PWHCNSY8=GS1.1.1626504080.2.1.1626504811.56`,
    userAgent: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36",
    withAgent: true,
    blockedRoutes: [
      "",
    ...
    responseModifiers: [
      function(body, userID) {
        ...
        while(body.includes("<script>eval(atob('aWYgKCEoZG9jdW1lbnQubG9jYXRpb24uaG9zdG5hbWUuZW5kc1dpdGgoJy53b29yYW5rLmNvbScpIHx8IGRvY3VtZW50LmxvY2F0aW9uLmhvc3RuYW1lID09PSAnbG9jYWxob3N0JykpIHdpbmRvdy5sb2NhdGlvbiA9ICdodHRwczovL3gvJzs='));</script>"))
        {
          console.log("found");
          body =  body.replace("<script>eval(atob('aWYgKCEoZG9jdW1lbnQubG9jYXRpb24uaG9zdG5hbWUuZW5kc1dpdGgoJy53b29yYW5rLmNvbScpIHx8IGRvY3VtZW50LmxvY2F0aW9uLmhvc3RuYW1lID09PSAnbG9jYWxob3N0JykpIHdpbmRvdy5sb2NhdGlvbiA9ICdodHRwczovL3gvJzs='));</script>" , " ");
        }
  ...
  insta: {
    ...
    redirectDomain: "insta." + baseDomain,
    redirectPath: "/editor",
    requestHeaderModifiers: [],
    responseHeaderModifiers: [],
    transformResponse: true,
    responseModifiers: [
      function(body, userID) {
        console.log("InstaText", "UserID: ", userID);
        return body;
      }
    ]
  },
  ...
  test: {
    productID: [18, 15, 21, 34, 39],
    address: 'https://maj.seopack.org',
    host: 'maj.seopack.org',
    userAgent: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36",
    cookie: `wordpress_test_cookie=WP%20Cookie%20check; _ga=GA1.2.2075759154.1626536058; _gid=GA1.2.1909652908.1626536058; wordpress_logged_in_6f60789958aae2c5f56fbe5f26559866=jokerseo3%7C1627745684%7CYClowVfQFvVXRLn1eDjpMVrdvOlUnvD6Hcw4JvVY3KM%7C7c339d9e55e472de45e8112831df9346c3989146226cab0f9f7ae4ad7f687b62; _gat_UA-2823791-31=1; _uetsid=73501c60e71411ebb1f2ffa59d0f9a8a; _uetvid=73507750e71411ebbfcb39b1e0967b88`,
    withAgent: true,
    blockedRoutes: [
...
app.use('*', async (req, res, next) => {
  ...
  if( toolID == "qt" )
  req.headers.host = "quetext.com"

  if( toolID == "wa" )
  req.headers.host = "wordai.com"

  if( toolID == "wr" )
  req.headers.host = "woorank.com"

  if( toolID == "insta" )
  req.headers.host = "instatext.io"
